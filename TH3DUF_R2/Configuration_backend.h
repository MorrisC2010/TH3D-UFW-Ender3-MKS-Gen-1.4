...
//Ender3 MKS GEN 1.3/1.4 Model Settings
#if ENABLED(ENDER3_MKS_GEN_13)
  #define BAUDRATE 115200
  ...
  #define Z_MIN_PROBE_ENDSTOP_INVERTING false
    ...
    #define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 800, TITAN_EXTRUDER_STEPS }
      ...
      #define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 400, CUSTOM_ESTEPS_VALUE }
    #else
      #define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 800, 200 } //Edit based on values for installed driver
    #endif
  #endif
  ...
  #undef Z_DRIVER_TYPE
  #undef E0_DRIVER_TYPE
  #define X_DRIVER_TYPE  DVR8825 //Change to driver installed
  #define Y_DRIVER_TYPE  DVR8825 //Change to driver installed
  #define Z_DRIVER_TYPE  DVR8825 //Change to driver installed
  #define E0_DRIVER_TYPE DVR8825 //Change to driver installed
  
  #define DEFAULT_MAX_FEEDRATE          { 300, 300, 15, 50 } //Edit based on values for installed driver
  #define DEFAULT_MAX_ACCELERATION      { 2000, 2000, 200, 10000 } //Edit based on values for installed driver
  ...
  #define UNIFIED_VERSION "TH3D for MKS GEN 1.4"
  

#endif //end Ender3 MKS Gen 1.3/1.4
