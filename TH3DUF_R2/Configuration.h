...
//=================================================================================================
// README - THE BELOW SETTINGS ARE ONLY FOR USING THE MKS GEN 1.4 WITH THE ENDER 3
// DO NOT UNCOMMENT THE ABOVE #define ENDER3 LINE IF USING THE GEN 1.4 BOARD
// Select 'Arduino Mega 2560' from Tools > Board - NOT Sanguino
//
// To use the Ender 3 LCD with the MKS GEN 1.4 connect the LCD cable to EXP1 on the 
// MKS GEN 1.4 board but rotate it 180 degrees. The LCD end of the cable goes to EXP3 on the Ender 3 LCD.
// You will have to force it into the EXP1 but it will fit and work.
// 
// EZABL and EZOut support are still supported just use the lines above this comment section.
//=================================================================================================

#define ENDER3_MKS_GEN_13
...
//#define TM3DAERO_EXTENDED
//#define PETSFANG  //This is the RIGHT mounted version - if using the left mount please use the CUSTOM_PROBE option.
//#define CUSTOM_PROBE  //uncomment for BLTouch
...
//#define BLTOUCH //Uncomment if you have BLTouch

//#define SERVO0_PIN 11 //Pin connected to BLTouch - Generally Pin 11 or 29 for Creality Melzi Boards

//#define Z_SAFE_HOMING //Homes Z axis in center of bed

//#define AUTO_BED_LEVELING_3POINT
//#define AUTO_BED_LEVELING_LINEAR
//#define AUTO_BED_LEVELING_BILINEAR  //Most Commonly Used
//#define AUTO_BED_LEVELING_UBL //Unified Bed Leveling - Most Advanced
